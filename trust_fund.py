...
# Demonstrates a logical error corrected
...
intrate = float(input("Return on trust fund (in percentage terms): "))

principal = total/(intrate/100)*12
